 ...
 */
// TODO: Consider this, currently this is plugged into an always on port
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  60, 180 }, { 300,  180 } }
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.026 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.026        // (mm) Compression length applying to all extruders
  #endif
