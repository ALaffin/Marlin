...
#define STRING_CONFIG_H_AUTHOR "(ALaffin, E5P-SKR3 EZ)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E5P-SKR3 EZ"
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.40
    #define DEFAULT_Ki   4.24
    #define DEFAULT_Kd   29.6
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 127.6
  #define DEFAULT_bedKi 13.51
  #define DEFAULT_bedKd 802.8
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 415.38 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -3 } //TODO: Measure this
